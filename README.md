...
Features
Change DNS servers on Windows with ease.
Ability to set up to 16 different servers.
User-friendly interface for seamless navigation.
Option to change the theme in the settings.
Usage
Run the program as an administrator.
Select your DNS server and connection.
Press the "Set" button to apply changes.
Wait for confirmation.
To remove a DNS server, select the connection and press the "Un-set" button.
Theme
